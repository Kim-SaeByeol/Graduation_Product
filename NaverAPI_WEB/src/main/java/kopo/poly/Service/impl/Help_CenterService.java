...
import kopo.poly.mapper.IHelp_CenterMapper;
...
@Service
public class Help_CenterService implements IHelp_CenterService {

    private final IHelp_CenterMapper centerMapper;
    /**
    ...
    public CenterDTO Geocoding(CenterDTO pDTO) throws Exception {
        ...
        String url = IHelp_CenterService.GeocodingApiURL + param;
...
//        CenterDTO rDTO = new ObjectMapper().readValue(json, CenterDTO.class);
    ...
    public List<CenterDTO> getCenterList() throws Exception {
        ...
        List<CenterDTO> resultList = centerMapper.getHelp_CenterList();
        if (resultList == null) {
        ...
        return centerMapper.getHelp_CenterList();
    }
    ...
    public void insertCenterInfo(CenterDTO centerDTO) throws Exception {
        ...
        centerMapper.insertHelp_CenterInfo(centerDTO);
    ...
    public void updateCenterList(CenterDTO centerDTO) throws Exception {
        ...
        centerMapper.updateHelp_CenterInfo(centerDTO);
    ...
    public void deleteCenterList(CenterDTO pDTO) throws Exception {
        ...
        centerMapper.deleteHelp_CenterInfo(pDTO);
